...
<div class="container">
	...
	<form:form modelAttribute="board" method="POST" action="../editok">
		...
		<table id="edit">
			...
			<tr><td>날씨</td><td><form:input path="weather"></form:input></td></tr>
			<tr><td>기분</td><td><form:input path="mood"></form:input></td></tr>
			<tr><td>오늘의 점수</td><td><form:input path="rating"></form:input></td></tr>
