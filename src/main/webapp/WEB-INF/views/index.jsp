...
<head>
    ...
    <style>
        ...
        #content #title  {
            width: 90%; /* 텍스트 박스의 넓이를 원하는 크기로 조정하세요. */
...
<div class="container">
    ...
    <div class="px-4 py-5 my-5 text-center">
        ...
        <h1 class="display-5 fw-bold text-body-emphasis">기억을 채우다</h1>
        <div class="col-lg-6 mx-auto">
            <p class="lead mb-4 extension-adhd-reader-p">매일의 순간들을 글로 담아보세요.<br> 그 순간들이 서로 어우러져 당신의 삶을 그립니다.</p>
            <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                <a href="login">
                    <button type="button" class="btn btn-primary btn-lg px-4 gap-3">로그인 하러 가기</button>
                </a>
            </div>
        </div>
    </div>
