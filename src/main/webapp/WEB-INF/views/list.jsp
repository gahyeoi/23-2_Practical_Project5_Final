...
<div class="container">
	...
	<table id="list" width="90%">
		...
		<tbody>
		<c:forEach items="${articles}" var="u" varStatus="status">
			<tr>
				<td>${u.writer}</td>
				<td>${u.title}</td>
				<td>${u.mood}</td>
				...
				<td>${u.regdate}</td>
				<td>
					<a href="views/${u.seq}">View</a>
					<a href="editform/${u.seq}">Edit</a>
					<a href="deleteok/${u.seq}" onclick="return confirm('Are you sure you want to delete this post?')">Delete</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
